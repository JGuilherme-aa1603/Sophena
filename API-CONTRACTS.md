...
- `cover_url`, when provided, must be a managed book cover URL generated by `/uploads/book-covers`
- external cover URLs must not be accepted
...
- if manual book includes `cover_url`, it must be a managed book cover URL generated by `/uploads/book-covers`
